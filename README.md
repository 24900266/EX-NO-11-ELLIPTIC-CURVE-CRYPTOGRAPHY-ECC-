...
int main() {
    ...
    printf("Enter Preethi's private key: ");
    scanf("%lld", &privateA);
    printf("Enter Prathyus's private key: ");
    scanf("%lld", &privateB);
    ...
    printf("Preethi's public key: (%lld, %lld)\n", publicA.x, publicA.y);
    printf("Prathyus's public key: (%lld, %lld)\n", publicB.x, publicB.y);
    ...
    printf("Shared secret computed by Preethi: (%lld, %lld)\n", sharedSecretA.x, sharedSecretA.y);
    printf("Shared secret computed by Prathyus: (%lld, %lld)\n", sharedSecretB.x, sharedSecretB.y);
...
<img width="1486" height="618" alt="image" src="https://github.com/user-attachments/assets/933da67f-e808-497b-9f99-556ca9c06b94" />
